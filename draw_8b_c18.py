...
class DRAW_8B_C18 ( ):
    ...
    *** Draw area ***
    ...
    def raw_line(self, x0:int, y0:int, x1:int, y1:int, color:int):
        ...
        while True:
            ...
            # Sending pixel data
            GPIO_OUT[0] = gpio1; GPIO_OUT_S[0] = wr_bit
            GPIO_OUT[0] = gpio2; GPIO_OUT_S[0] = wr_bit
            GPIO_OUT[0] = gpio3; GPIO_OUT_S[0] = wr_bit
    ...
    *** Text area ***
    ...
    def rgb(self, red :int, green :int, blue :int)->int:
        ...
        return ( ((red >> 2) << 10) & 0x3F000  | ((green >> 2) << 4) & 0xFC0 | ((blue >> 2) >> 2) & 0x3F )
